...
from ABCpractice import MessageFactory
...
class Bot:
    ...
    def handle(self, action):
        if action == 'add':
            ...
            MESSAGE_FACTORY.get_message('ActionSearch')
            ...
            for account in result:
                if account['birthday']:
                    ...
                    MESSAGE_FACTORY.get_message(result)
        elif action == 'edit':
            ...
            MESSAGE_FACTORY.get_message(self.book.congratulate())
        elif action == 'view':
            MESSAGE_FACTORY.get_message(self.book)
        elif action == 'exit':
            pass
        else:
            MESSAGE_FACTORY.get_message('CommandError')
