    ...
    def __init__(self, value=''):
        while True:
            ...
            try:
                ...
                MESSAGE_FACTORY.get_message('PhoneError')
            else:
                break
    ...
    def __init__(self, value=''):
        while True:
            ...
            try:
                ...
                MESSAGE_FACTORY.get_message('BirthdayError')
    ...
    def __init__(self, value=''):
        while True:
            ...
            try:
                ...
                MESSAGE_FACTORY.get_message('EmailError')
    ...
    def __init__(self, value=''):
        while True:
            ...
            try:
                ...
                MESSAGE_FACTORY.get_message('StatusError')
